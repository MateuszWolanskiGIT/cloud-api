# Look up the available AZs in the current region (don't hardcode them)
data "aws_availability_zones" "available" {
  state = "available"
}

# The VPC - your isolated private network
...
# Two public subnets, one in each of the first two AZs
